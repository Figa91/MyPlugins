...
public OnPluginStart()
{
	...
	RegConsoleCmd("sm_silencer", ToggleSilencer, "sm_silencer - Toggle Silencer");
	...
	upNightVisionEnable = CreateConVar( "l4d_enable_night_vision", "0", "1 - Enable Toggle Night Vision Upgrade; 0 - Disable This Upgrade", FCVAR_PLUGIN);
	upFastReloadEnable = CreateConVar( "l4d_enable_fast_reload", "0", "1 - Enable Toggle Fast Reload Upgrade; 0 - Disable This Upgrade", FCVAR_PLUGIN);
...
{
	ClientCommand(client, "bind l sm_laser; bind k sm_silent");
}
